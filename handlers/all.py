...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton(" • قناه السورس •", url="https://t.me/BLACK_TEAM_4")],[InlineKeyboardButton("تواصل السورس 📥", url="t.me/f_ire_awn45bot")],[InlineKeyboardButton("شروحات السورس 🗽", url="t.me/BLACK_TEAM_4"")]]),[InlineKeyboardButton(" مبرمج السورس 🔥", url="t.me/a_j_o_k_e_r"")]]),[InlineKeyboardButton(" مبرمج السورس 🔥", url="t.me/TTnnT"")]])
...
Botuser = client.get_me().username
    ...
    if text == "عدد المجموعات " and (rank is not False or rank is not  0 ):
